...
-- Schema pecs_lms
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `pecs_lms` DEFAULT CHARACTER SET utf8 ;
USE `pecs_lms` ;
...
CREATE TABLE IF NOT EXISTS `pecs_lms`.`Usuario` (
  ...
  `codigoConfirmacion` VARCHAR(90) CHARACTER SET utf8 COLLATE utf8_bin NULL COMMENT 'Codigo para confirmacion de registro',
...
CREATE TABLE IF NOT EXISTS `pecs_lms`.`SeccionPrograma` (
  ...
  `codigoInscripcion` VARCHAR(20) CHARACTER SET utf8 COLLATE utf8_bin NULL COMMENT 'Codigo para inscribirse a la seccion',
  `fechaCreacion` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `pecs_lms`.`Modulo` (
  ...
  `bloqueo` DATETIME NULL COMMENT 'Modulo bloqueado hasta fecha mencionada (Bloqueado es pero no tiene funcionalidad sus items)',
...
CREATE TABLE IF NOT EXISTS `pecs_lms`.`ItemArchivo` (
  ...
  `bloqueo` DATETIME NULL COMMENT 'Item bloqueado hasta fecha mencionada (Item pero su descripcion esta bloqueada)',
